...
for (const simpson of simpsons) {
    ...
    memberName.innerText = simpson.name + ' ' + simpson.surname;
    div.appendChild(memberName);

    let memberAge = document.createElement('h5');
    memberAge.innerText = 'Возраст:' + ' ' + simpson.age;
    div.appendChild(memberAge);
